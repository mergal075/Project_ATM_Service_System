...
public class AdminAccess {
	...
	public static void GeneratePin() throws SQLException {
		...
		System.out.println("Enter the AccountNo : ");
		 ...
		 st=conn.createStatement();
		String sql="select * from atm where accno="+accno+" and pin="+p  ;
		//String sql="select * from atm where accno="+accno;
		rs=st.executeQuery(sql);
		if(rs.next()) {
...
//Get Mini Statements details
	...
	public static void DisplayAllCustomer() throws SQLException {
		
		st=conn.createStatement();
		
		String q="select * from atm ";
		 rs=st.executeQuery(q);
		 System.out.println("accno \t acc holder name \t balance \t pin \t status");
		 while(rs.next())
		 {
			 System.out.println(rs.getInt("accno")+" \t"+rs.getString("accholderName")+"\t \t"+rs.getInt("balance")+"\t"+rs.getInt("pin")+"\t"+rs.getString("acctype"));
	...
	public static void UpdateAtm() throws SQLException {
		
		st=conn.createStatement();
		System.out.println("Enter the Account No : ");
		int accno= sc.nextInt();sc.nextLine();
		System.out.println("Enter the name of the updated Name of aaccount holder: ");
		String as=sc.nextLine();
		String s1="update atm set accholdername='"+as+"' where accno="+accno;
